...
hold off;
xlabel('$I$','FontSize',12,'Interpreter','latex');      % x轴
ylabel('$t$','FontSize',12,'Interpreter','latex');  % y轴
title(sprintf('I-t （舍弃前%d组数据）', x-1), ...
    'FontSize', 14);
